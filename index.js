...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    displayNames.forEach(array => displayNames.push(`name: ${array.animal_name}, scientific: ${array.scientific_name}`));
    return displayNames;
  }
  console.log(animalNames(zooAnimals));
  // Admittedly kinda sloppy. Reaches desired effect.
  ...
  */
  ...
  function lowerCaseNames(array){
    const newArr = array.map(item => item.animal_name.toLowerCase());
    return newArr;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const newArr = array.filter(item => { return item.population < 5});
    return newArr;
  }
  ...
  */
  ...
  function USApop(array){
    const newArr = array.reduce((acc, currentValue) => {
